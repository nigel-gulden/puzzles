    ...
    : m_draggable(false), m_state(WAITING_FOR_TEXT)
{
    ...
    m_sayings.append("It is certain");
    m_sayings.append("It is decidedly so");
    m_sayings.append("Without a doubt");
    m_sayings.append("Yes., definitely");
    m_sayings.append("You may rely on it");
    m_sayings.append("As I see it, yes");
    m_sayings.append("Most likely");
    m_sayings.append("Outlook good");
    m_sayings.append("Yes");
    m_sayings.append("Signs point to yes");
    m_sayings.append("Reply hazy try again");
    m_sayings.append("Ask again later");
    m_sayings.append("Better not tell you now");
    m_sayings.append("Cannot predict now");
    m_sayings.append("Concentrate and ask again");
    m_sayings.append("Don't count on it");
    m_sayings.append("My reply is no");
    m_sayings.append("My sources say no");
    m_sayings.append("Outlook not so good");
    m_sayings.append("Very doubtful");
